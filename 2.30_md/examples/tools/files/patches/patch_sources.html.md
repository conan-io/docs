<a id="examples-tools-files-patches"></a>
...
We can also use the `conandata.yml` [introduced in the tutorial](https://docs.conan.io/2//tutorial/creating_packages/handle_sources_in_packages.html.md#creating-packages-handle-sources-in-packages-conandata) so we
...
Check [patch](https://docs.conan.io/2//reference/tools/files/patches.html.md#conan-tools-files-patch) for more details.
...
[apply_conandata_patches](https://docs.conan.io/2//reference/tools/files/patches.html.md#conan-tools-files-apply-conandata-patches) to see the full supported yml) you
