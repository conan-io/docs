<a id="reference-commands-custom-generators"></a>
...
[python_requires](https://docs.conan.io/2//reference/extensions/python_requires.html.md#reference-extensions-python-requires). You could declare a
...
<a id="reference-commands-custom-generators-tool-requires"></a>
