<a id="consuming-packages-tool-requires"></a>
...
The main difference is the addition of the [[tool_requires]](https://docs.conan.io/2//reference/config_files/profiles.html.md#reference-config-files-profiles-tool-requires) section in the
...
Please check [the profile doc](https://docs.conan.io/2//reference/config_files/profiles.html.md#reference-config-files-profiles) for more
information.
...
[profiles section](https://docs.conan.io/2//reference/config_files/profiles.html.md#reference-config-files-profiles).
...
#### SEE ALSO
- [JFrog Academy Conan 2 Essentials Module 1, Lesson 4: Using Build Tools As Conan Packages](https://academy.jfrog.com/path/conan-cc-package-manager/conan-2-essentials?utm_source=Conan+Docs)
- [Using [platform_tool_requires] in your profiles](https://docs.conan.io/2//reference/config_files/profiles.html.md#reference-config-files-profiles-platform-tool-requires).
- [Creating recipes for tool_requires: packaging build tools](https://docs.conan.io/2//tutorial/creating_packages/other_types_of_packages/tool_requires_packages.html.md#tutorial-other-tool-requires-packages).
...
- [Using a MinGW as tool_requires to build with gcc in Windows](https://docs.conan.io/2//examples/dev_flow/tool_requires/mingw.html.md#examples-dev-flow-tool-requires-mingw)
- [Using tool_requires in profiles](https://docs.conan.io/2//reference/config_files/profiles.html.md#reference-config-files-profile-patterns)
