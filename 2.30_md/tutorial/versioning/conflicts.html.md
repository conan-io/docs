<a id="tutorial-versioning-conflicts"></a>
...
the [examples2 repository](https://github.com/conan-io/examples2):
...
- Version-ranges can also produce some version conflicts, even if Conan tries to reduce them. This [FAQ about version conflicts](https://docs.conan.io/2//knowledge/faq.html.md#faq-version-conflicts-version-ranges) discusses the graph resolution algorithm and strategies to minimize the conflicts.
