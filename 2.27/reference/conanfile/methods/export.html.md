<a id="reference-conanfile-methods-export"></a>
...
- Only files that are necessary for the evaluation of the `conanfile.py` recipe must be exported with this method. Files necessary for building from sources should be exported with the `exports_sources` attribute or the [export_source()](https://docs.conan.io/2//reference/conanfile/methods/export_sources.html.md#reference-conanfile-methods-export-sources) method.
