<a id="reference-config-files-credentials"></a>
...
- With a custom [auth plugin](https://docs.conan.io/2//reference/extensions/authorization_plugins.html.md#reference-extensions-authorization-plugin).
