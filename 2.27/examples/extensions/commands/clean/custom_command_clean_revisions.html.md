<a id="examples-extensions-commands-clean-revisions"></a>
...
In this example we are going to see how to create/use a custom command: **conan clean**. It removes
...
#### NOTE
To understand better this example, it is highly recommended to read previously the [Custom commands reference](https://docs.conan.io/2//reference/extensions/custom_commands.html.md#reference-commands-custom-commands).

## Locate the command

Copy the command file `cmd_clean.py` into your `[YOUR_CONAN_HOME]/extensions/commands/` folder (create it if it’s not there).
If you don’t know where `[YOUR_CONAN_HOME]` is located, you can run **conan config home** to check it.
...
so if you want to know more about its API, visit [its official website](https://docs.python.org/3/library/argparse.html).
...
If you want to know more about the Conan API, visit the [ConanAPI section](https://docs.conan.io/2//reference/extensions/python_api/ConanAPI.html.md#reference-python-api-conan-api)
