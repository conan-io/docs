<a id="examples-tools-autotools-create-first-package-windows"></a>
...
In the [Create your first Conan package with Autotools](https://docs.conan.io/2//examples/tools/autotools/create_your_first_package.html.md#examples-tools-autotools-create-first-package)
...
#### SEE ALSO
- [GNU built-in integrations reference](https://docs.conan.io/2//reference/tools/gnu.html.md#conan-tools-gnu).
