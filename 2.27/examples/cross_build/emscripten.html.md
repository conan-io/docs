<a id="examples-cross-build-emscripten"></a>
...
Conan supports [WASM](https://webassembly.org) cross compilation, giving you the flexibility to target different
...
#### NOTE
Conan also supports building for [asm.js](http://asmjs.org) targets, which is a nowadays considered deprecated.
...
#### IMPORTANT
According to [emscripten documentation](https://emscripten.org/docs/api_reference/wasm_workers.html) Emscripten supports two multithreading APIs:
...
The profiles above use the `emsdk` package from [Conan Center Index repository](https://conan.io/center/recipes/emsdk), which provides the Emscripten SDK, including `emcc`, `em++`, and tools like `emrun` and `node`.
...
[tools.cmake.cmaketoolchain:user_toolchain](https://docs.conan.io/2//reference/tools/cmake/cmaketoolchain.html.md#conan-cmake-user-toolchain)
