...
5. conan client has computed the needed binary package SHA and now will get it. So will request and download the package ``conan_info`` file to perform some checks like outdated binaries.
