<a id="tutorial-versioning-lockfiles"></a>
...
Let’s see it with a practical example, start cloning  the [examples2 repository](https://github.com/conan-io/examples2):
...
#### SEE ALSO
- [CI tutorial](https://docs.conan.io/2//ci_tutorial/tutorial.html.md#ci-tutorial).
