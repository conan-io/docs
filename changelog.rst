...
- Feature: Added ``compatibility.py`` extension mechanism to allow users define binary compatibility globally.
...
- Feature: Used the package immutability for improved update, install and upload flows.