...
- Feature: Allow ``=~`` as an alias for the ``=!`` (unset) operator in configuration. `#20084 <https://github.com/conan-io/conan/pull/20084>`_ . Docs `here <https://github.com/conan-io/docs/pull/XXXX>`__
