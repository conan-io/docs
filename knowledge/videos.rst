...
Using std::cpp 2025
-------------------
`An introduction to the Common Package Specification (CPS) for C and C++` by Diego Rodriguez-Losada
...
Using std::cpp 2024
-------------------
`Unlock the power of Conan 2 - 15 new features you didn’t know about!` by Luis Caro & Diego Rodriguez-Losada
...
Meeting C++ 2023
----------------
`CMake and Conan: past, present and future` by Diego Rodriguez-Losada
...
Using std::cpp 2021
-------------------
`Why you shouldn’t write your own C++ package manager` by Luis Caro Campos
...
-----------------------------------
`Conan 2.0 demo` by Chris McArthur
