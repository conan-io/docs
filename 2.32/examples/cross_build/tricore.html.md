<a id="example-cross-build-tricore"></a>
...
There are multiple compilers for TriCore, some of which can be found [here](https://www.infineon.com/cms/en/tools/aurix-tools/Compilers/). There are also `gcc`
...
#### NOTE
- This support is new and experimental. Please create a ticket in [https://github.com/conan-io/conan/issues](https://github.com/conan-io/conan/issues) for any feedback or issues
