<a id="setup-local-recipes-index"></a>
...
- Simplify the process of building binaries from a private conan-center-index
  ...
  Guide [Local Recipes Index Repository](https://docs.conan.io/2//devops/devops_local_recipes_index.html.md#devops-local-recipes-index).
...
[Artifactory](https://docs.conan.io/2//tutorial/conan_repositories/setting_up_conan_remotes/artifactory/artifactory_ce_cpp.html.md#artifactory-ce-cpp).

#### SEE ALSO
- [DevOps guide](https://docs.conan.io/2//devops/devops.html.md#devops)
