<a id="conan-tools-system-package-manager"></a>
...
[configuration](#conan-tools-system-package-manager-config).
...
<a id="conan-tools-system-package-manager-methods"></a>
...
*Apt* that also accepts the *recommends* argument for the [install
method](#conan-tools-system-package-manager-apt).
...
* `install(self, packages, update=False, check=True, host_package=True):` try to install
  ...
  [configuration](#conan-tools-system-package-manager-config). If the parameter
  ...
  name (see [Explicit architecture suffixes](#conan-tools-system-package-manager-explicit-arch-suffix)). This method
...
<a id="conan-tools-system-package-manager-config"></a>
...
<a id="conan-tools-system-package-manager-apk"></a>
...
<a id="conan-tools-system-package-manager-apt"></a>
...
* **Parameters:**
  ...
  * **update** – try to update the package manager database before checking and installing.
  * **check** – check if the packages are already installed before installing them.
  * **host_package** – install the packages for the host machine architecture (the machine
    that will run the software), it has an effect when cross building.
  * **recommends** – if the parameter `recommends` is `False` it will add the
...
<a id="conan-tools-system-package-manager-explicit-arch-suffix"></a>
...
<a id="conan-tools-system-package-manager-yum"></a>
...
*Yum* and *Dnf* also support [explicit architecture suffixes](#conan-tools-system-package-manager-explicit-arch-suffix) using `.` as separator
...
constructor and methods than the [Yum](#conan-tools-system-package-manager-yum) tool.
