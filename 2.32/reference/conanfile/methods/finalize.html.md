<a id="reference-conanfile-methods-finalize"></a>
...
This info is also serialized as part of the graph information in **conan graph info** etc.
...
and performing cache integrity checks either thru **conan cache check-integrity** or as part of the upload processes
in **conan upload ... --check** would raise errors if the modified package was ever checked.

#### WARNING
This is not a replacement for the [post_package](https://docs.conan.io/2//reference/extensions/hooks.html.md#reference-extensions-hooks) hook.
