<a id="reference-binary-model-settings-options"></a>
...
In that case, the recipe should remove the option in the [package_id() method](https://docs.conan.io/2//reference/conanfile/methods/package_id.html.md#reference-conanfile-methods-package-id):
...
it should be done via the [conf section](https://docs.conan.io/2//reference/config_files/profiles.html.md#reference-config-files-profiles-conf) of your profile. Then in the recipe we should just add:
...
#### SEE ALSO
- [How the package_id is computed](https://docs.conan.io/2//reference/binary_model/package_id.html.md#reference-binary-model-package-id)
- [Configure settings and options in recipes](https://docs.conan.io/2//tutorial/creating_packages/configure_options_settings.html.md#tutorial-creating-configure)
