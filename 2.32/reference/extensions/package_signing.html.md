<a id="reference-extensions-package-signing"></a>
...
- [Signing packages with Sigstore (Cosign)](https://docs.conan.io/2//examples/extensions/package_signing/package_signing_with_sigstore.html.md#examples-extensions-package-signing-sigstore).
- [Signing packages with OpenSSL](https://docs.conan.io/2//examples/extensions/package_signing/package_signing_with_openssl.html.md#examples-extensions-package-signing-openssl).
