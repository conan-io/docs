...
documentation, visit [Artifactory docs](https://docs.jfrog.com/artifactory/docs/getting-started).
...
the [Single node Artifactory installation](https://docs.jfrog.com/installation/docs/docker)
and the full [Artifactory installation guide](https://docs.jfrog.com/installation/docs/installing-artifactory).
