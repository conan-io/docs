<a id="creating-packages-handle-sources-in-packages"></a>

# Handle sources in packages

In the [previous tutorial section](https://docs.conan.io/2//tutorial/creating_packages/create_your_first_package.html.md#creating-packages-create-your-first-conan-package),
...
We used the [conan.tools.files.get()](https://docs.conan.io/2//reference/tools/files/downloads.html.md#conan-tools-files-get) tool that will first
...
the [conan.tools.files.unzip()](https://docs.conan.io/2//reference/tools/files/basic.html.md#conan-tools-files-unzip) reference for more details).
...
Conan recipe, so if you do a **conan create** the results will be the
same as before.
...
Here, we use the [conan.tools.scm.Git()](https://docs.conan.io/2//reference.html.md#reference) tool. The `Git` class
implements several methods to work with *git* repositories. In this case, we call the `clone()`
method to clone the [https://github.com/conan-io/libhello.git](https://github.com/conan-io/libhello.git) repository in the
...
[conan.tools.scm.Git()](https://docs.conan.io/2//reference.html.md#reference) reference.

Note that it’s also possible to run other commands by invoking the `self.run()` method.

<a id="creating-packages-handle-sources-in-packages-conandata"></a>
...
see the [graph info json format](https://docs.conan.io/2//reference/commands/formatters/graph_info_json_formatter.html.md#reference-commands-graph-info-json-format)

#### SEE ALSO
- [JFrog Academy Conan 2 Essentials Module 2, Lesson 8: Package Creation and Uploading](https://academy.jfrog.com/path/conan-cc-package-manager/conan-2-essentials-module-2-package-creation-and-uploading?utm_source=Conan+Docs)
- [Patching sources](https://docs.conan.io/2//examples/tools/files/patches/patch_sources.html.md#examples-tools-files-patches)
- [Capturing Git SCM source information](https://docs.conan.io/2//examples/tools/scm/git/capture_scm/git_capture_scm.html.md#examples-tools-scm-git-capture) instead of copying sources with `exports_sources`.
- [source() method reference](https://docs.conan.io/2//reference/conanfile/methods/source.html.md#reference-conanfile-methods-source)
