...
- **apple_system**: Defines `CMAKE_OSX_ARCHITECTURES` (see the [universal binaries section](#conan-tools-cmaketoolchain-universal-binaries)), `CMAKE_OSX_SYSROOT` for Apple systems.
