...
- Define **dependencies options values** in **profile files**, not in recipes. Do not define `default_options`
  ...
  [this FAQ about options values for dependencies](https://docs.conan.io/2//knowledge/faq.html.md#faq-different-options-values) for more information.

<a id="guidelines-bad-alphanumeric-majors"></a>
