...
- [`DownloadAPI.recipe_metadata`](https://docs.conan.io/2//reference/extensions/python_api/DownloadAPI.html.md#conan.api.subapi.download.DownloadAPI.recipe_metadata)
- [`DownloadAPI.package_metadata`](https://docs.conan.io/2//reference/extensions/python_api/DownloadAPI.html.md#conan.api.subapi.download.DownloadAPI.package_metadata)
...
This is an **experimental** feature. We are looking forward to hearing your feedback, use cases and needs, to keep improving this feature. Please report it in [Github issues](https://github.com/conan-io/conan/issues)
