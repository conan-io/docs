<a id="examples-tools-gnu-pkg-config-sysroot"></a>

# Using PkgConfig.fill_cpp_info with PKG_CONFIG_PATH from a profile

The [PkgConfig](https://docs.conan.io/2//reference/tools/gnu/pkgconfig.html.md#conan-tools-gnu-pkgconfig) helper can read a `.pc` file and use
