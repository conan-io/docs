<a id="examples-tools-scm-git-capture"></a>
...
- When the recipe is exported to the Conan cache, the `export()` method executes, `git.coordinates_to_conandata()`,
  ...
  See the [Git reference](https://docs.conan.io/2//reference/tools/scm/git.html.md#conan-tools-scm-git) for more information about these methods.
