...
[package_type_traits](https://docs.conan.io/2//reference/conanfile/attributes.html.md#conan-conanfile-attributes-package-type-traits) in
its recipe.
...
### *class* VirtualRunEnv(conanfile, auto_generate=False, win_copy_folder=None)
...
* **Parameters:**
  ...
  * **auto_generate** – Automatically generate .bat or .sh files
  * **win_copy_folder** – Copy the “bindirs” folders contents from dependencies into this
