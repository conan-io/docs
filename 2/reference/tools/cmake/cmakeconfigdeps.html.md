<a id="conan-tools-cmakeconfigdeps"></a>
...
`CMakeConfigDeps` will use the common [self.cpp_info](https://docs.conan.io/2//reference/conanfile/methods/package_info.html.md#conan-conanfile-model-cppinfo) fields, like `includedirs`, `libs`, etc.
...
<a id="cmakeconfigdeps-properties"></a>
...
Using this method you can overwrite the [property](#cmakeconfigdeps-properties) values
set by the Conan recipes from the consumer.

* **Parameters:**
  * **dep** – Name of the dependency to set the [property](#cmakeconfigdeps-properties).
    For components use the syntax: `dep_name::component_name`.
  * **prop** – Name of the [property](https://docs.conan.io/2//reference/tools/cmake/cmakedeps.html.md#cmakedeps-properties).
