<a id="reference-conanfile-methods-generate"></a>
...
Generation of files happens in the [generators_folder](https://docs.conan.io/2//reference/conanfile/attributes.html.md#attribute-generators-folder) as defined by the current layout.
...
<a id="conan-conanfile-model-dependencies"></a>
...
- **ref**: A [RecipeReference](https://docs.conan.io/2//reference/extensions/python_api/model/references.html.md#conan-api-model-recipereference) object that contains `name`, `version`, `user`, `channel` and `revision` (recipe revision)
...
- **recipe**: The `recipe` type of the dependency (e.g., “Cache”). This should only be used for [informational](https://github.com/conan-io/conan/issues/18996) or reporting purposes. Using it for any kind of conditional logic on the consumers side is considered bad practice and unsupported.
...
the dependency is in the cache or is an [editable package](https://docs.conan.io/2//tutorial/developing_packages/editable_packages.html.md#editable-packages).
