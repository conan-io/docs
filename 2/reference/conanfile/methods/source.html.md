<a id="reference-conanfile-methods-source"></a>
...
<a id="reference-conanfile-methods-source-caching"></a>
...
#### SEE ALSO
See [the tutorial about managing recipe sources](https://docs.conan.io/2//tutorial/creating_packages/handle_sources_in_packages.html.md#creating-packages-handle-sources-in-packages) for more information.
