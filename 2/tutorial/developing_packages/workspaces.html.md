...
#### SEE ALSO
Read the [workspace files](https://docs.conan.io/2//reference/workspace_files.html.md#reference-workspace-files) section.
Read the [conan workspace command](https://docs.conan.io/2//reference/commands/workspace.html.md#reference-commands-workspace) section.

<a id="tutorial-workspaces-monolithic"></a>
...
and are dictionaries with the reference `ref` (of type [RecipeReference](https://docs.conan.io/2//reference/extensions/python_api/model/references.html.md#conan-api-model-recipereference)) and the source folder `folder` of
...
<a id="tutorial-workspaces-orchestrated"></a>
