<a id="creating-packages-preparing-the-build"></a>

# Preparing the build

In the [previous tutorial section](https://docs.conan.io/2//tutorial/creating_packages/add_dependencies_to_packages.html.md#creating-packages-add-dependencies-to-packages),
we added the [fmt](https://conan.io/center/fmt) requirement to our Conan package to
...
* Writing files to be used in the build step, like
  [scripts](https://docs.conan.io/2//reference/tools/env/environment.html.md#conan-tools-env-environment-model) that inject environment variables,
...
* Based on the value of the `with_fmt` option:
  ...
  > - We conditionally inject the `WITH_FMT` variable with the value `True` to the [CMakeToolchain](https://docs.conan.io/2//reference/tools/cmake/cmaketoolchain.html.md#conan-tools-cmaketoolchain) so that we
...
[CMakeToolchain](https://docs.conan.io/2//reference/tools/cmake/cmaketoolchain.html.md#conan-tools-cmaketoolchain). Depending on the value we will try to find
...
* Access certain information about the package dependencies, like:
  > - The configuration via [conf_info](https://docs.conan.io/2//reference/conanfile/methods/package_info.html.md#conan-conanfile-model-conf-info).
  > - The options of dependencies.
  > - Import files from dependencies using the [copy tool](https://docs.conan.io/2//reference/tools/files/basic.html.md#conan-tools-files-copy).
  >   You could also import the files to create manifests for the package, collecting all
  >   versions and licenses of dependencies.
* Use the [Environment tools](https://docs.conan.io/2//reference/tools/env/environment.html.md#conan-tools-env-environment-model) to generate
...
- Use the `generate()` method to [import files from dependencies](https://docs.conan.io/2//tutorial/consuming_packages/the_flexibility_of_conanfile_py.html.md#copy-resources-on-generate).
- [generate() method reference](https://docs.conan.io/2//reference/conanfile/methods/generate.html.md#reference-conanfile-methods-generate)
