...
* We define a `test()` method. This method will only be invoked in *test_package*
  ...
  - We are using the [conan.tools.build.cross_building](https://docs.conan.io/2//reference/tools/build.html.md#conan-tools-build-can-run)
...
created the `hello/1.0` package in the Conan cache. This is done with the [conan
test](https://docs.conan.io/2//reference/commands.html.md#reference-commands) command:
...
#### SEE ALSO
- [JFrog Academy Conan 2 Essentials Module 2, Lesson 12: Testing Conan Packages](https://academy.jfrog.com/path/conan-cc-package-manager/conan-2-essentials-module-2-package-creation-and-uploading?utm_source=Conan+Docs)
