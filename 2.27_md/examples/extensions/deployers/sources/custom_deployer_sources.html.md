...
#### NOTE
To better understand this example, it is highly recommended to have previously read the [Deployers](https://docs.conan.io/2//reference/extensions/deployers.html.md#reference-extensions-deployer-direct-deploy) reference.

## Locate the deployer

In this case, the deployer is located in the same directory as our example conanfile,
but as shown in [Deployers](https://docs.conan.io/2//reference/extensions/deployers.html.md#reference-extensions-deployer-direct-deploy) reference,
...
under `dependencies_sources` using [conan.tools.copy](https://docs.conan.io/2//reference/tools/files/basic.html.md#conan-tools-files-copy).
...
nor in those commands that do not require building, such as **conan graph**.
