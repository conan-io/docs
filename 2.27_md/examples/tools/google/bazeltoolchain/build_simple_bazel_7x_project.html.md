<a id="examples-tools-bazel-7x-toolchain-build-simple-bazel-project"></a>
...
#### NOTE
This example is based on the [Build a simple CMake project using Conan](https://docs.conan.io/2//tutorial/consuming_packages/build_simple_cmake_project.html.md#consuming-packages-build-simple-cmake-project)
