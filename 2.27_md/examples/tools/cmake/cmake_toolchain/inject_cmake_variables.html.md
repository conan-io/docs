<a id="examples-tools-cmake-toolchain-inject-variables"></a>

# CMakeToolchain: Inject arbitrary CMake variables into dependencies

You can find the sources to recreate this project in the [examples2 repository](https://github.com/conan-io/examples2) in GitHub:
