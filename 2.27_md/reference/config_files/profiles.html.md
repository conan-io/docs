<a id="reference-config-files-profiles"></a>
...
Profiles can be created with the `detect` option in [conan profile](https://docs.conan.io/2//reference/commands/profile.html.md#reference-commands-profile) command,
...
Profile files can be used with `-pr`/`--profile` option in many commands like **conan install** or
**conan create** commands. If you don’t specify any profile at all, the `default` profile will be
always used:
...
<a id="reference-config-files-profiles-using-profiles"></a>
...
#### SEE ALSO
- Manage your profiles and share them using [conan config install](https://docs.conan.io/2//reference/commands/config.html.md#reference-commands-conan-config-install).
- Check the command and its sub-commands of [conan profile](https://docs.conan.io/2//reference/commands/profile.html.md#reference-commands-profile).
...
List of settings available from [settings.yml](https://docs.conan.io/2//reference/config_files/settings.html.md#reference-config-files-settings-yml):
...
#### SEE ALSO
- This section allows to use patterns to limit which packages are affected by the setting. See [this section](#reference-config-files-profile-patterns) for more details.
...
#### SEE ALSO
- This section allows to use patterns to limit which packages are affected by the options. See [this section](#reference-config-files-profile-patterns) for more details.

<a id="reference-config-files-profiles-tool-requires"></a>
...
#### SEE ALSO
- This section allows to use patterns to limit which packages are affected by the tool requirement. See [this section](#reference-config-files-profile-patterns) for more details.
- Read more about tool requires in this section: [Using build tools as Conan packages](https://docs.conan.io/2//tutorial/consuming_packages/use_tools_as_conan_packages.html.md#consuming-packages-tool-requires).

<a id="reference-config-files-profiles-system-tools"></a>

### [system_tools] (DEPRECATED)

#### NOTE
This section is **deprecated** and has been replaced by [[platform_requires]](#reference-config-files-profiles-platform-requires) and [[platform_tool_requires]](#reference-config-files-profiles-platform-tool-requires) sections.

<a id="reference-config-files-profiles-buildenv"></a>

### [buildenv]

List of environment variables that will be injected to the environment every time the ConanFile
`run(cmd, env="conanbuild")` method is invoked (build time context is automatically run by [VirtualBuildEnv](https://docs.conan.io/2//reference/tools/env/virtualbuildenv.html.md#conan-tools-env-virtualbuildenv)).
...
#### SEE ALSO
- This section allows to use patterns to limit which packages are affected by the buildenv. See [this section](#reference-config-files-profile-patterns) for more details.
...
<a id="reference-config-files-profiles-runenv"></a>

### [runenv]

List of environment variables that will be injected to the environment every time the ConanFile
`run(cmd, env="conanrun")` method is invoked (runtime context is automatically run by [VirtualRunEnv](https://docs.conan.io/2//reference/tools/env/virtualrunenv.html.md#conan-tools-env-virtualrunenv)).

All the operators/patterns explained for [[buildenv]](#reference-config-files-profiles-buildenv) applies to this one in the same way:
...
#### SEE ALSO
- This section allows to use patterns to limit which packages are affected by the runenv. See [this section](#reference-config-files-profile-patterns) for more details.

<a id="reference-config-files-profiles-conf"></a>

### [conf]

#### NOTE
It’s recommended to have previously read the [global.conf](https://docs.conan.io/2//reference/config_files/global_conf.html.md#reference-config-files-global-conf) section.
...
They can also be used in [global.conf](https://docs.conan.io/2//reference/config_files/global_conf.html.md#reference-config-files-global-conf),
...
#### SEE ALSO
- This section allows to use patterns to limit which packages are affected by the confs. See [this section](#reference-config-files-profile-patterns) for more details.

<a id="reference-config-files-profiles-replace-requires"></a>
...
<a id="reference-config-files-profiles-replace-tool-requires"></a>
...
<a id="reference-config-files-profiles-platform-requires"></a>
...
<a id="reference-config-files-profiles-platform-tool-requires"></a>
...
<a id="reference-config-files-profiles-rendering"></a>
...
<a id="reference-config-files-profiles-detect-api"></a>
...
<a id="reference-config-files-profile-patterns"></a>
...
#### SEE ALSO
- [How to compose two or more profiles](https://docs.conan.io/2//reference/commands/install.html.md#reference-commands-install-composition)
