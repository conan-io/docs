<a id="conan-tools-gnu-autotoolstoolchain"></a>
...
Since [Conan 2.4.0](https://github.com/conan-io/conan/releases/tag/2.4.0),
...
See more info in the [conf section](#conan-tools-gnu-autotoolstoolchain-conf).
...
The [Autotools build helper](https://docs.conan.io/2//reference/tools/gnu/autotools.html.md#conan-tools-gnu-build-helper) will use that `conanbuild.conf` file to seamlessly call
...
variables from the `[conf]` section in the profiles. [See the conf reference below](#conan-tools-gnu-autotoolstoolchain-conf).
...
[global.conf](https://docs.conan.io/2//reference/config_files/global_conf.html.md#reference-config-files-global-conf) to extend the `configure_args` attribute.
...
* **Parameters:**
  ...
  * **namespace** – This argument avoids collisions when you have multiple toolchain calls in
...
* **Parameters:**
  **updated_flags** – `dict` with arguments as keys and their argument values.
...
<a id="conan-tools-gnu-autotoolstoolchain-conf"></a>
