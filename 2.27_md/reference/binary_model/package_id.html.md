<a id="reference-binary-model-package-id"></a>
...
In the next section [how the versions affect the package_id](https://docs.conan.io/2//reference/binary_model/dependencies.html.md#reference-binary-model-dependencies) is explained.
