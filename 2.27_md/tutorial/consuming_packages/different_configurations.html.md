<a id="consuming-packages-different-configurations"></a>
...
<a id="different-configurations-modify-settings"></a>
...
<a id="different-configurations-modify-options"></a>
...
<a id="settings-and-options-difference"></a>
...
#### SEE ALSO
- [JFrog Academy Conan 2 Essentials Module 1, Lesson 2: Building For Multiple Configurations With Conan And CMake Presets](https://academy.jfrog.com/path/conan-cc-package-manager/conan-2-essentials?utm_source=Conan+Docs)
- [VirtualRunEnv reference](https://docs.conan.io/2//reference/tools/env/virtualrunenv.html.md#conan-tools-env-virtualrunenv)
- [Cross-compiling using –profile:build and –profile:host](https://docs.conan.io/2//tutorial/consuming_packages/cross_building_with_conan.html.md#consuming-packages-cross-building-with-conan)
...
- [Installing configurations with conan config install](https://docs.conan.io/2//reference/commands/config.html.md#reference-commands-conan-config-install)
- VS Multi-config
- [How settings and options influence the package id](https://docs.conan.io/2//reference/binary_model/settings_and_options.html.md#reference-binary-model-settings-options)
- [Using patterns for settings and options](https://docs.conan.io/2//reference/config_files/profiles.html.md#reference-config-files-profile-patterns)
