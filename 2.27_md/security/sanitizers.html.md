...
at [Developer Community](https://developercommunity.visualstudio.com/cpp). Very recently Visual Studio 2026 added
...
* MSVC: [MSVC Sanitizers](https://learn.microsoft.com/en-us/cpp/sanitizers/).
...
[customize new compiler sub-settings](https://docs.conan.io/2//reference/config_files/settings.html.md#reference-config-files-customizing-settings). You should not need
to modify `settings.yml` directly; instead add [the settings_user.yml](https://docs.conan.io/2//examples/config_files/settings/settings_user.html.md#examples-config-files-settings-user).
...
If you already have a [custom CMake toolchain file](https://docs.conan.io/2//reference/tools/cmake/cmaketoolchain.html.md#conan-cmake-user-toolchain) to manage compiler
...
[Building Examples Using Sanitizers](https://docs.conan.io/2//examples/security/sanitizers.html.md#examples-security-sanitizers) section in the examples.
