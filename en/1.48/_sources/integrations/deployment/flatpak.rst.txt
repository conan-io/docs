...
`Flatpak <https://flatpak.org>`_ (former ``xdg-app``) is a package management system to distribute desktop applications for Linux. It is based on `OSTree <https://en.wikipedia.org/wiki/OSTree>`_.
