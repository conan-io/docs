<a id="reference-runners-docker"></a>
...
- `cache` **(optional, default: clean)**: Determines how the Docker container interacts with the host’s Conan cache.
  ...
  > - `copy`: Copies the host cache into the container using the [conan cache save/restore](https://docs.conan.io/2//reference/commands/cache.html.md#reference-commands-cache) command.
...
- [Creating a Conan package using a Docker runner](https://docs.conan.io/2//examples/runners/docker/basic.html.md#examples-runners-docker-basic)
- [Using a docker runner configfile to parameterize the Dockerfile base image](https://docs.conan.io/2//examples/runners/docker/configfile_build_args.html.md#examples-runners-docker-configfile-build-args)
