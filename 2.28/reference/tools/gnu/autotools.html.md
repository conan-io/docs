<a id="conan-tools-gnu-build-helper"></a>
...
It will read the `conanbuild.conf` file generated by the [AutotoolsToolchain](https://docs.conan.io/2//reference/tools/gnu/autotoolstoolchain.html.md#conan-tools-gnu-autotoolstoolchain)
...
* **Parameters:**
  ...
  * **build_script_folder** – Subfolder where the configure script is located. If not specified
...
* **Parameters:**
  * **target** – (Optional, Defaulted to `None`): Choose which target to build. This allows
...
* **Parameters:**
  * **args** – (Optional, Defaulted to `None`): List of arguments to use for the
    ...
    [tools.microsoft.unix_path() function](https://docs.conan.io/2//reference/tools/microsoft/helpers.html.md#conan-tools-microsoft-unix-path)
...
[fix_apple_shared_install_name()](https://docs.conan.io/2//reference/tools/apple/other.html.md#conan-tools-apple-fix-apple-shared-install-name)
