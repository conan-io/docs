<a id="examples-dev-flow-tool-requires-mingw"></a>
...
#### SEE ALSO
- The ConanCenter web page for the [mingw-builds package](https://conan.io/center/recipes/mingw-builds)
- The `conan-center-index` [mingw-builds Github repo recipe](https://github.com/conan-io/conan-center-index/tree/master/recipes/mingw-builds/all)
