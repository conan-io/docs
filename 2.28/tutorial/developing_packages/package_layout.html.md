<a id="tutorial-package-layout"></a>

# Understanding the Conan Package layout

<a id="developing-packages-layout"></a>
...
`hello/1.0` consumer used in the [editable packages](https://docs.conan.io/2//tutorial/developing_packages/editable_packages.html.md#editable-packages) tutorial.
...
[cmake_layout()](https://docs.conan.io/2//reference/tools/cmake/cmake_layout.html.md#cmake-layout) in the `say/1.0` ConanFile, but instead, we are
...
multi-config, please check the [cmake_layout()](https://docs.conan.io/2//reference/tools/cmake/cmake_layout.html.md#cmake-layout) in the Conan
documentation.
...
**conan create** on the `say` package:
...
#### SEE ALSO
- Define the layout() [when you package third-party libraries](https://docs.conan.io/2//examples/conanfile/layout/third_party_libraries.html.md#examples-conanfile-layout-third-party-libraries)
- Define the layout() [when you have the conanfile in a subfolder](https://docs.conan.io/2//examples/conanfile/layout/conanfile_in_subfolder.html.md#examples-conanfile-layout-conanfile-in-subfolder)
- Define the layout() [when you want to handle multiple subprojects](https://docs.conan.io/2//examples/conanfile/layout/multiple_subprojects.html.md#examples-conanfile-layout-multiple-subprojects)
