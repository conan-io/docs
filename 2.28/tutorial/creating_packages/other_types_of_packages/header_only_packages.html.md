<a id="creating-packages-other-header-only"></a>
...
In the [Create your first Conan package](https://docs.conan.io/2//tutorial/creating_packages/create_your_first_package.html.md#creating-packages-create-your-first-conan-package) section, we learned about settings and how building the
...
Also check that we are setting the [no_copy_source](https://docs.conan.io/2//reference/conanfile/attributes.html.md#conan-conanfile-properties-no-copy-source) attribute to `True` so that the source code
...
#### SEE ALSO
- [JFrog Academy Conan 2 Essentials Module 3, Lesson 14: Creating A Recipe For Header-Only Libraries](https://academy.jfrog.com/path/conan-cc-package-manager/conan-2-essentials-module-3-advanced-package-creation-scenarios?utm_source=Conan+Docs)
