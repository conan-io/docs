<a id="tutorial-versioning-version-ranges"></a>
...
<a id="tutorial-versioning-semantic"></a>

## Semantic versioning

The semantic versioning specification or [semver](https://semver.org/), specifies that packages should
...
<a id="tutorial-version-ranges-expressions"></a>
...
[which you can read more about here](https://docs.conan.io/2//devops/versioning/resolve_prereleases.html.md#resolve-prereleases-summary).
...
For more information about valid range expressions go to [Requires reference](https://docs.conan.io/2//reference/conanfile/attributes.html.md#version-ranges-reference)
...
see [The effect of dependencies on package_id](https://docs.conan.io/2//reference/binary_model/dependencies.html.md#reference-binary-model-dependencies).
