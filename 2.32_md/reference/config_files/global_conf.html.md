...
core.download:download_cache: Define path to a file download cache. Files uploaded to a server are also stored here, so a later download of the same artifact can be skipped
