...
#### source(path, name=None, version=None, user=None, channel=None, remotes: List[[Remote](https://docs.conan.io/2//reference/extensions/python_api/model/remote.html.md#conan.api.model.Remote)] = None, lockfile=None)
...
* **Parameters:**
  ...
  * **channel** – The channel of the package. If not defined, it is taken from conanfile
  * **remotes** – The remotes to resolve possible `python-requires` for this recipe if needed.
  * **lockfile** – The lockfile to use for the `python-requires` resolution, if needed.
