...
See [Using PkgConfig.fill_cpp_info with PKG_CONFIG_PATH from a profile](https://docs.conan.io/2//examples/tools/gnu/pkg_config_sysroot.html.md#examples-tools-gnu-pkg-config-sysroot) for a full example.
