<a id="reference-commands-graph-info-json-format"></a>
...
The JSON output generated by **conan graph info --require=zlib/1.2.11 -r=conancenter --format=json > graph.json**
for instance:
