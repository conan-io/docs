<a id="tutorial-creating-configure"></a>

# Configure settings and options in recipes

We already explained [Conan settings and options](https://docs.conan.io/2//tutorial/consuming_packages/different_configurations.html.md#settings-and-options-difference)
...
You can see that we added a [configure() method](https://docs.conan.io/2//reference/conanfile/methods/configure.html.md#reference-conanfile-methods-configure) to the recipe. Let’s explain what the
...
<a id="creating-packages-configure-options-settings"></a>
...
libraries](https://docs.conan.io/2//tutorial/creating_packages/other_types_of_packages/header_only_packages.html.md#creating-packages-other-header-only). In that case,
...
methods reference](https://docs.conan.io/2//reference/conanfile/methods.html.md#reference-conanfile-methods) if you want to know how this method works in
more detail.

#### SEE ALSO
- [JFrog Academy Conan 2 Essentials Module 2, Lesson 11: Configuring Settings And Options](https://academy.jfrog.com/path/conan-cc-package-manager/conan-2-essentials-module-2-package-creation-and-uploading?utm_source=Conan+Docs)
- [Header-only packages](https://docs.conan.io/2//tutorial/creating_packages/other_types_of_packages/header_only_packages.html.md#creating-packages-other-header-only).
- Check the binary compatibility [compatibility.py extension](https://docs.conan.io/2//reference/extensions/binary_compatibility.html.md#reference-extensions-binary-compatibility).
- Conan [package types](https://docs.conan.io/2//reference/conanfile/attributes.html.md#reference-conanfile-attributes-package-type).
- [Setting package_id_mode for requirements](https://docs.conan.io/2//reference/conanfile/methods/requirements.html.md#reference-conanfile-methods-requirements-package-id-mode).
