<a id="creating-packages-package-method"></a>

# Package files: the package() method

We already used the `package()` method in our hello package to invoke CMake’s install
step. In this tutorial, we will explain the use of [CMake.install()](https://docs.conan.io/2//reference/tools/cmake/cmake.html.md#conan-tools-cmake-helper) in more detail and also how to modify this method to do things
like:

- Using [conan.tools.files](https://docs.conan.io/2//reference/tools/files.html.md#conan-tools-files) utilities to copy the generated
...
the `CMAKE_INSTALL_PREFIX` CMake variable to point to the recipe’s [package_folder](https://docs.conan.io/2//reference/conanfile/attributes.html.md#conan-conanfile-properties-package-folder) attribute. Then, just calling install() in
...
[package_folder](https://docs.conan.io/2//reference/conanfile/attributes.html.md#conan-conanfile-properties-package-folder). In this case, you can
use the [tools.files.copy](https://docs.conan.io/2//reference/tools/files/basic.html.md#conan-tools-files-copy) function to make that copy. We
...
won’t manipulate symlinks by default, so we provide several [tools](https://docs.conan.io/2//reference/tools/files/symlinks.html.md#id1) to convert absolute symlinks to relative ones and to remove
...
- [package() method reference](https://docs.conan.io/2//reference/conanfile/methods/package.html.md#reference-conanfile-methods-package)
