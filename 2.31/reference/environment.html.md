<a id="reference-environment-variables"></a>
...
[global.conf configuration](https://docs.conan.io/2//reference/config_files/global_conf.html.md#reference-config-files-global-conf) and the [profile [conf] section](https://docs.conan.io/2//reference/config_files/profiles.html.md#reference-config-files-profiles)

<a id="reference-environment-variables-conan-home"></a>
