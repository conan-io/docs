<a id="reference-conanfile-methods-system-requirements"></a>
...
For full reference of the built-in helpers for different system package managers read the [tools.system.package_manager documentation](https://docs.conan.io/2//reference/tools/system/package_manager.html.md#conan-tools-system-package-manager).
...
- Use the `build_system_requirements()` method (from Conan 2.30), that is similar to this `system_requirements()`
  but exclusively installed when it is necessary to build from source (and using the “build” architecture). See [docs for build_system_requirements()](https://docs.conan.io/2//reference/conanfile/methods/build_system_requirements.html.md#reference-conanfile-methods-build-system-requirements)
...
There are examples [for build-time system requirements in this section](https://docs.conan.io/2//examples/tools/system/system_package/consuming_system_packages.html.md#examples-tools-system-consuming-system-packages)
