<a id="resolve-prereleases-summary"></a>
...
but [as described in the version ranges tutorial](https://docs.conan.io/2//tutorial/versioning/version_ranges.html.md#tutorial-version-ranges-expressions),
by default Conan does not match pre-release versions to ranges that don’t specify it.

Conan provides the [global.conf](https://docs.conan.io/2//reference/config_files/global_conf.html.md#reference-config-files-global-conf) `core.version_ranges:resolve_prereleases` conf,
...
If `zlib/1.3-pre` is now published, using it is as easy as modifying your [global.conf](https://docs.conan.io/2//reference/config_files/global_conf.html.md#reference-config-files-global-conf)
