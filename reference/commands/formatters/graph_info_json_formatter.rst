...
The JSON output generated by :command:`conan graph info --require=zlib/1.3.1 -r=conancenter --format=json > graph.json`
for instance:
...

    {
        "graph": {
            "nodes": {
                ...
                "1": {
                    "ref": "zlib/1.3.1#ffa77daf83a57094149707928bdce823",
                    "id": "1",
                    "recipe": "Cache",
