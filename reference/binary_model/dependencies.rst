...
.. _reference_binary_model_dependencies_versioning:


Default versioning approach
----------------------------

The above behavior is the default for ``embed`` and ``non_embed`` mode. These defaults are intended to work with the
following versioning approach:
