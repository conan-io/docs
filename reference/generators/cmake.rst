...
Default Targets generated by CMake
----------------------------------

When a compiler or its version is not detected, the CMake helper generates a default target based on the platform operating system.
