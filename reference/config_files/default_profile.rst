...
.. code-block:: text
    ...
    [buildenv]
    PATH=(path)$PROFILE_DIR/dev_tools
...
Package settings and buildenv vars
----------------------------------

Profiles also support **package settings** and **package build environment variables** definition,
so you can override some settings or environment variables for some specific package:
...
- Create a ``[CONAN_HOME]/profiles/clang`` file:
