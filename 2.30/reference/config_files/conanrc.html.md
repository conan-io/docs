<a id="reference-config-files-conanrc"></a>
...
conan_home value. This value will take precedence over the [CONAN_HOME](https://docs.conan.io/2//reference/environment.html.md#reference-environment-variables-conan-home) environment variable in case it’s also
