<a id="consuming-packages-flexibility-of-conanfile-py"></a>
...
packages in the [Creating Packages](https://docs.conan.io/2//tutorial/creating_packages.html.md#tutorial-creating-packages) section later.
...
[requirements()](https://docs.conan.io/2//reference/conanfile/methods/requirements.html.md#reference-conanfile-methods-requirements) and
[build_requirements()](https://docs.conan.io/2//reference/conanfile/methods/build_requirements.html.md#reference-conanfile-methods-build-requirements) docs.
...
<a id="consuming-packages-flexibility-of-conanfile-py-use-layout"></a>
...
CMake case, there’s a [cmake_layout()](https://docs.conan.io/2//reference/tools/cmake/cmake_layout.html.md#cmake-layout) already defined in Conan:
...
The [validate() method](https://docs.conan.io/2//reference/conanfile/methods/validate.html.md#reference-conanfile-methods-validate) is evaluated when Conan loads the *conanfile.py* and you can use
...
You could add some logic to the [requirements() method](https://docs.conan.io/2//reference/conanfile/methods/requirements.html.md#reference-conanfile-methods-requirements) to add or remove requirements
...
<a id="copy-resources-on-generate"></a>
...
[generate() method](https://docs.conan.io/2//reference/conanfile/methods/generate.html.md#reference-conanfile-methods-generate) you can copy these
...
[blog post about using the Dear ImGui library](https://blog.conan.io/2019/06/26/An-introduction-to-the-Dear-ImGui-library.html), which
...
local cache using [generators](https://docs.conan.io/2//reference/tools.html.md#conan-tools) and [environment
tools](https://docs.conan.io/2//reference/tools/env/virtualrunenv.html.md#conan-tools-env-virtualrunenv) without the need to copy them to the local
folder.
...
#### SEE ALSO
- [JFrog Academy Conan 2 Essentials Module 1, Lesson 3: The Flexibility Of Using A conanfile.py](https://academy.jfrog.com/path/conan-cc-package-manager/conan-2-essentials?utm_source=Conan+Docs)
- [Using “cmake_layout” + “CMakeToolchain” + “CMakePresets feature” to build your project](https://docs.conan.io/2//examples/tools/cmake/cmake_toolchain/build_project_cmake_presets.html.md#examples-tools-cmake-toolchain-build-project-presets).
- [Understanding the Conan Package layout](https://docs.conan.io/2//tutorial/developing_packages/package_layout.html.md#tutorial-package-layout).
- [Documentation for all conanfile.py available methods](https://docs.conan.io/2//reference/conanfile/methods.html.md#reference-conanfile-methods).
