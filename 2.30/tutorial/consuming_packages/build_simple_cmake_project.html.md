<a id="consuming-packages-build-simple-cmake-project"></a>
...
build systems in the [Read More
section](#consuming-packages-read-more).
...
libraries from a remote server called [ConanCenter](https://conan.io/center/).
You can search there for libraries and also check the available versions. In our case,
after checking the available versions for [Zlib](https://conan.io/center/zlib) we
...
>   as our project is based on *CMake*, we will use [CMakeDeps](https://docs.conan.io/2//reference/tools/cmake/cmakedeps.html.md#conan-tools-cmakedeps) to
>   generate information about where the **Zlib** library files are installed and
>   [CMakeToolchain](https://docs.conan.io/2//reference/tools/cmake/cmaketoolchain.html.md#conan-tools-cmaketoolchain) to pass build information to *CMake*
...
to find it using the [tools.build:compiler_executables
configuration](https://docs.conan.io/2//reference/tools/cmake/cmaketoolchain.html.md#conan-cmake-toolchain-conf).
...
See [Building with CMake presets](https://docs.conan.io/2//examples/tools/cmake/cmake_toolchain/build_project_cmake_presets.html.md#examples-tools-cmake-toolchain-build-project-presets)

<a id="consuming-packages-read-more"></a>

#### SEE ALSO
- [JFrog Academy Conan 2 Essentials Module 1, Lesson 1: Building A Simple CMake Project From Conan](https://academy.jfrog.com/path/conan-cc-package-manager/conan-2-essentials?utm_source=Conan+Docs)
- [Building with CMake presets](https://docs.conan.io/2//examples/tools/cmake/cmake_toolchain/build_project_cmake_presets.html.md#examples-tools-cmake-toolchain-build-project-presets)
- [Getting started with Autotools](https://docs.conan.io/2//examples/tools/autotools/build_project_autotools_toolchain.html.md#examples-tools-autotools-autotools-toolchain-build-project-autotools-toolchain)
...
- [Getting started with Bazel](https://docs.conan.io/2//examples/tools/google/bazeltoolchain/build_simple_bazel_project.html.md#examples-tools-bazel-toolchain-build-simple-bazel-project)
- [Getting started with Bazel 7.x](https://docs.conan.io/2//examples/tools/google/bazeltoolchain/build_simple_bazel_7x_project.html.md#examples-tools-bazel-7x-toolchain-build-simple-bazel-project)
