<a id="examples-tools-microsoft-create-first-package"></a>
...
#### SEE ALSO
- Check the [Conan Visual Studio Extension](https://docs.conan.io/2//integrations/visual_studio.html.md#integrations-visual-studio-extension).
- [MSBuild built-in integrations reference](https://docs.conan.io/2//reference/tools/microsoft.html.md#conan-tools-microsoft).
