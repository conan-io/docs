<a id="reference-extensions-hooks"></a>
...
There are some officially maintained hooks in its own repository in [Conan hooks GitHub](https://github.com/conan-io/hooks),
but mostly are only compatible with Conan 1.x, so please, check first the [README](https://github.com/conan-io/hooks/blob/master/README.md)
