<a id="consuming-packages-intro-versioning"></a>
...
<a id="tutorial-consuming-packages-versioning-lockfiles"></a>
...
#### SEE ALSO
- [JFrog Academy Conan 2 Essentials Module 1, Lesson 6: Intro To Versioning](https://academy.jfrog.com/path/conan-cc-package-manager/conan-2-essentials?utm_source=Conan+Docs)
- [Introduction to Versioning](https://docs.conan.io/2//tutorial/versioning.html.md#tutorial-versioning)
