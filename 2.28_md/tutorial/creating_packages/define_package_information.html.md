<a id="tutorial-creating-define-package-info"></a>
...
library in a Conan package using the [package
method](https://docs.conan.io/2//tutorial/creating_packages/package_method.html.md#creating-packages-package-method). Consumers that depend on that package will
...
[cpp_info](https://docs.conan.io/2//reference/conanfile/methods/package_info.html.md#conan-conanfile-model-cppinfo) attribute of the ConanFile. The information
for this attribute must be set in the [package_info() method](https://docs.conan.io/2//reference/conanfile/methods/package_info.html.md#reference-conanfile-methods-package-info). Let’s have a look at the
...
find them in the [examples2 repository](https://github.com/conan-io/examples2) on
GitHub:
...
First, please note that we are using [another branch](https://github.com/conan-io/libhello/tree/package_info) from the **libhello** library.
...
<a id="tutorial-creating-define-package-info-properties"></a>

## Properties model: setting information for specific generators

The [CppInfo](https://docs.conan.io/2//reference/conanfile/methods/package_info.html.md#conan-conanfile-model-cppinfo-attributes) object provides the
`set_property` method to set information specific to each generator. For example, in
this tutorial, we use the [CMakeDeps](https://docs.conan.io/2//reference/tools/cmake/cmakedeps.html.md#conan-tools-cmakedeps) generator to generate the
...
the [reference](https://docs.conan.io/2//reference/tools/cmake/cmakedeps.html.md#cmakedeps-properties).
...
you can use the ConanFile’s [runenv_info](https://docs.conan.io/2//reference/conanfile/attributes.html.md#conan-conanfile-attributes-runenv-info) and
[buildenv_info](https://docs.conan.io/2//reference/conanfile/attributes.html.md#conan-conanfile-attributes-buildenv-info) properties:

* `runenv_info` [Environment](https://docs.conan.io/2//reference/tools/env/environment.html.md#conan-tools-env-environment-model) object that
  defines environment information that consumers that use the package may need when
  **running**.
* `buildenv_info` [Environment](https://docs.conan.io/2//reference/tools/env/environment.html.md#conan-tools-env-environment-model) object that
  defines environment information that consumers that use the package may need when
  **building**.
...
[VirtualBuildEnv](https://docs.conan.io/2//reference/tools/env/virtualbuildenv.html.md#conan-tools-env-virtualbuildenv) and
[VirtualRunEnv](https://docs.conan.io/2//reference/tools/env/virtualrunenv.html.md#conan-tools-env-virtualrunenv).
...
[conf_info](https://docs.conan.io/2//reference/conanfile/methods/package_info.html.md#conan-conanfile-model-conf-info) property of the `ConanFile`.

To learn more about this use case, please check the [corresponding
example](https://docs.conan.io/2//examples/conanfile/package_info/package_info_conf_and_env.html.md#examples-conanfile-package-info-conf-and-env).
...
attribute from the [CppInfo](https://docs.conan.io/2//reference/conanfile/methods/package_info.html.md#conan-conanfile-model-cppinfo-attributes) object.

To know more about this use case, please check the [components
example](https://docs.conan.io/2//examples/conanfile/package_info/components.html.md#examples-conanfile-package-info-components) in the examples section.

#### SEE ALSO
- [JFrog Academy Conan 2 Essentials Module 2, Lesson 10: The package() And package_info() Methods](https://academy.jfrog.com/path/conan-cc-package-manager/conan-2-essentials-module-2-package-creation-and-uploading?utm_source=Conan+Docs)
- [Propagating environment and configuration information to consumers example](https://docs.conan.io/2//examples/conanfile/package_info/package_info_conf_and_env.html.md#examples-conanfile-package-info-conf-and-env)
- [Define components for Conan packages that provide multiple libraries example](https://docs.conan.io/2//examples/conanfile/package_info/components.html.md#examples-conanfile-package-info-components)
- [package_info() reference](https://docs.conan.io/2//reference/conanfile/methods/package_info.html.md#reference-conanfile-methods-package-info)
