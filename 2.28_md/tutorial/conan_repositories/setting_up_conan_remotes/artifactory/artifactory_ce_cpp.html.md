...
documentation, visit [Artifactory docs](https://jfrog.com/help/).
...
the [Single node Artifactory installation](https://jfrog.com/help/r/jfrog-installation-setup-documentation/install-artifactory-single-node-with-docker)
and the full [Artifactory installation guide](https://jfrog.com/help/r/jfrog-installation-setup-documentation).

For versions older than Artifactory 7.77, alternative installation methods like
downloading installers from [Download Page](https://conan.io/downloads.html) are available.
