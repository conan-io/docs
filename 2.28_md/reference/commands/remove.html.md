<a id="reference-commands-remove"></a>
...
There are other commands like **conan list** (see the patterns documentation there [conan list](https://docs.conan.io/2//reference/commands/list.html.md#reference-commands-list)), **conan upload** and **conan download**, that take the same patterns.
