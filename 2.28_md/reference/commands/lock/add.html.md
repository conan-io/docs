...
requires=pkg/version", but they must be recipe references, including at least
...
Please have a look to the [lockfiles tutorial](https://docs.conan.io/2//tutorial/versioning/lockfiles.html.md#tutorial-versioning-lockfiles).
