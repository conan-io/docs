<a id="reference-commands-profile"></a>
...
Use **conan profile show** to compute the resulting build and host profiles from
...
It’s also useful to show the result of the evaluation of [jinja2 templates in the
profiles](https://docs.conan.io/2//reference/config_files/profiles.html.md#reference-config-files-profiles-rendering). For example, a profile like this:
...
#### SEE ALSO
- Read more about [profiles](https://docs.conan.io/2//reference/config_files/profiles.html.md#reference-config-files-profiles)
