<a id="conan-tools-microsoft-msbuildtoolchain"></a>
...
last one emulates the `vcvarsall.bat` env script. See also [`VCVars`](https://docs.conan.io/2//reference/tools/microsoft/vcvars.html.md#conan.tools.microsoft.VCVars).
