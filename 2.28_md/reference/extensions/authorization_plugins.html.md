<a id="reference-extensions-authorization-plugin"></a>
...
Regarding authorization, we have two plugins: one focused on remote  [Conan servers](https://docs.conan.io/2//tutorial/conan_repositories/setting_up_conan_remotes.html.md#setting-up-conan-remotes)
...
This first plugin is a Python script that receives a [Remote](https://docs.conan.io/2//reference/extensions/python_api/model/remote.html.md#conan-api-model-remote) object and an optional parameter: `user`. If the user
