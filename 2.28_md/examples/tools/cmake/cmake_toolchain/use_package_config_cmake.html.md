<a id="examples-tools-cmake-toolchain-use-package-config-cmake"></a>
...
You can find the sources to recreate this example in the [examples2 repository](https://github.com/conan-io/examples2) in GitHub:
