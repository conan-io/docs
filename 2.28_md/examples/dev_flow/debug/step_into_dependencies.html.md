<a id="examples-dev-flow-debug-step-into"></a>
...
#### SEE ALSO
- Modifying the dependency source code while debugging is not possible with this approach. If that is the intended flow, the recommended approach is to use [editable package](https://docs.conan.io/2//tutorial/developing_packages/editable_packages.html.md#editable-packages).
